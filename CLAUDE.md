...
Instruction to CLAUDE: For every session, please insert a session summary in this document at the top with date, including a TLDR, context, problem, solution, next steps.
...
- [task_004_sample_songs.md](dev/task_004_sample_songs.md) - Sample song files
- [task_005_history_tracking.md](dev/task_005_history_tracking.md) - Worship history tracking
- [task_006_import.md](dev/task_006_import.md) - URL import (YouTube lyrics extraction)
- [task_009_church_accounting.md](dev/task_009_church_accounting.md) - Church accounting / bookkeeping / donor receipts / 990 filing
- [task_010_website_redesign.md](dev/task_010_website_redesign.md) - Astro static site for lsc.church (bilingual zh-TW/en, Cloudflare Pages)
